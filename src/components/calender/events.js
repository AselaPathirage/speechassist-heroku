...
export default [
  ...
  {
    id: 24,
    title: 'Harith Iduwara',
    start: new Date(2022, 7, 22, 18, 30, 0),
    end: new Date(2022, 7, 22, 20, 0, 0),
  },
  {
    id: 25,
    title: 'Nimesh Nishamal',
    start: new Date(2022, 7, 25, 18, 30, 0),
    end: new Date(2022, 7, 25, 20, 0, 0),
    patient:'Nimesh Nishamal',
    
  },
  {
    id: 26,
    title: 'Yasith Samaradivkara',
    start: new Date(2022, 7, 20, 18, 30, 0),
    end: new Date(2022, 7, 20, 20, 0, 0),
  },
  {
    id: 27,
    title: 'Asela Pathirage',
